...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="mobile-only-brand pull-left">
    <div class="nav-header pull-left">
      <div class="logo-wrap">
        <a href="index.html">
          <img class="brand-img" src="backend/dist/img/logo.png" alt="brand"/>
          <span class="brand-text">Mirpurit</span>
        </a>
      </div>
    </div>
  ...
  <div id="mobile_only_nav" class="mobile-only-nav pull-right">
    <ul class="nav navbar-right top-nav pull-right">
            ...
            <ul class="pa-20">
              ...
              <li class="col-md-6 col-xs-12 preview-carousel">
                ...
                <div class="product-carousel owl-carousel owl-theme text-center">
                  <a href="#">
                    <img src="backend/dist/img/chair.jpg" alt="chair">
                    <span>Circle chair</span>
                  </a>
                  <a href="#">
                    <img src="backend/dist/img/chair2.jpg" alt="chair">
                    <span>square chair</span>
                  </a>
                  <a href="#">
                    <img src="backend/dist/img/chair3.jpg" alt="chair">
                    <span>semi circle chair</span>
                  </a>
                  <a href="#">
                    <img src="backend/dist/img/chair4.jpg" alt="chair">
          ...
          <li>
            <div class="streamline message-nicescroll-bar">
              ...
              <div class="sl-item">
                <a href="javascript:void(0)">
                  <div class="sl-avatar">
                    <img class="img-responsive" src="backend/dist/img/avatar.jpg" alt="avatar"/>
                  </div>
                  <div class="sl-content">
      ...
      <li class="dropdown auth-drp">
        <a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown"><img src="backend/dist/img/user1.png" alt="user_auth" class="user-auth-img img-circle"/><span class="user-online-status"></span></a>
