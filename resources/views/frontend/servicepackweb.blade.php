...
<body>
    ...
    <div class="page-wrapper">
      ...
      <section class="cover" style="margin-top: 105px;">
        <img src="assets/images/background/website.gif" alt="" style="margin: auto;display:block;">
        ...
        <section class="pricing-one" id="pricing" style="background-color: var(--thm-gray);">
            <div class="container" style=" padding-bottom: 74px;">
                ...
                <div class="tabed-content">
                    <div id="month">
                        <div class="row">
                            <div class="col-lg-4 wow fadeInLeft mb-3" data-wow-duration="1500ms">
                            ...
                            <div class="col-lg-4 wow fadeInRight" data-wow-duration="1500ms">
                                <div class="pricing-one__single">
                                    <div class="pricing-one__inner">
                                        ...
                                        <h3 style="font-size:25px;">Multivendor Website</h3>
                                        <p>40000 TK</p>
                                        <ul class="list-unstyled pricing-one__list">
                                            <li><i class="fa fa-check"></i> Extra features</li>
                                            <li><i class="fa fa-check"></i> Lifetime free support</li>
                            ...
                            <div class="col-lg-4 wow fadeInUp" data-wow-duration="1500ms">
                                <div class="pricing-one__single">
                                    <div class="pricing-one__inner">
                                        ...
                                        <h3 style="font-size:25px;">News Site</h3>
                                        <p>15000 TK</p>
                            ...
                            <div class="col-lg-4 wow fadeInRight" data-wow-duration="1500ms">
                                <div class="pricing-one__single">
                                    <div class="pricing-one__inner">
                                        <img src="assets/images/shapes/pricing-line-1-1.png" alt="" class="pricing-one__line">
                                        <img src="assets/images/shapes/pricing-icon-1-3.png" alt="" class="pricing-one__icon">
                                        <h3 style="font-size:25px;">Personal Website </h3>
                                        <p>12000 TK</p>
                                        <ul class="list-unstyled pricing-one__list">
                                            <li><i class="fa fa-check"></i> Extra features</li>
                                            <li><i class="fa fa-check"></i> Lifetime free support</li>
                                ...
                                <div class="col-lg-4 wow fadeInRight" data-wow-duration="1500ms">
                                    <div class="pricing-one__single">
                                        <div class="pricing-one__inner">
                                            <img src="assets/images/shapes/pricing-line-1-1.png" alt="" class="pricing-one__line">
                                            <img src="assets/images/shapes/pricing-icon-1-3.png" alt="" class="pricing-one__icon">
                                            <h3 style="font-size:25px;">Business Website </h3>
                                            <p>15000 TK</p>
                            ...
                            <div class="col-lg-4 wow fadeInRight" data-wow-duration="1500ms">
                                <div class="pricing-one__single">
                                    <div class="pricing-one__inner">
                                        <img src="assets/images/shapes/pricing-line-1-1.png" alt="" class="pricing-one__line">
                                        <img src="assets/images/shapes/pricing-icon-1-3.png" alt="" class="pricing-one__icon">
                                        <h3 style="font-size:25px;">Travel site </h3>
                                        <p>15000 TK</p>
