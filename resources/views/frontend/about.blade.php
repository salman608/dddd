   ...
   <section class="blog-one blog-one__home blog-one__grid">
            <div class="container">
            	<div class="block-title text-center">
                    ...
                    <h3>Meet the Team</h3>
                    <h2>Meet Our team for whome we are here.</h2>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-one__single">
                            <div class="blog-one__image">
                                <img src="assets/images/testimonials/testi-1-2.jpg" alt="">
                            </div><!-- /.blog-one__image -->
                            <div class="blog-one__content">
                            	<ul class="blog-one__meta list-unstyled">
                                    <li><a href="#" style="color: purple;font-weight:bold; font-size:18px;">Saiful Islam Tusher</a></li>
                                    <li><a href="#" style="color: black;font-weight:bold;">Founder & CEO</a></li>
                                </ul><!-- /.blog-one__meta list-unstyled -->
                               
                                <h3 class="text-justify" style="font-size:18px;">” In this competitive age construct Your business more modern to face the collision ”</h3>                             
                                <!-- /.blog-one__link -->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-one__single">
                            <div class="blog-one__image">
                                <img src="assets/images/testimonials/testi-1-1.jpg" alt="">
                            </div><!-- /.blog-one__image -->
                             <div class="blog-one__content">
                            	<ul class="blog-one__meta list-unstyled">
                                    <li><a href="#" style="color: purple;font-weight:bold; font-size:18px;">Mizanur Rafi</a></li>
                                    <li><a href="#" style="color: black;font-weight:bold;">Founder & COO</a></li>
                                </ul><!-- /.blog-one__meta list-unstyled -->
                               
                                <h3 class="text-justify" style="font-size:18px;">“In the age of information-technology many of us are very Far from it. Our attempt to bring them in the touch of this ray in an accessible way.”</h3>                             
                                <!-- /.blog-one__link -->
                            </div><!-- /.blog-one__content -->
                        </div><!-- /.blog-one__single -->
                    </div><!-- /.col-lg-4 -->
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__content">
                            	<ul class="blog-one__meta list-unstyled">
                                    <li><a href="#">Saiful Islam Tusher</a></li>
                                    <li><a href="#">Founder & CEO</a></li>
                                </ul><!-- /.blog-one__meta list-unstyled -->
                               
                                <h3 class="text-left">” In this competitive age construct Your business more modern to face the collision ”</h3>                             
                                <!-- /.blog-one__link -->
                            </div><!-- /.blog-one__content -->
                        </div><!-- /.blog-one__single -->
                    </div><!-- /.col-lg-4 -->                                                
